...
if ( $testMMDVModeDMR == 1 ) {
  ...
  <table>
	...
	echo '    </tr>'."\n";
	echo '    <tr>'."\n";
	echo '      <td colspan="3"><b><a href="https://w0chp.net/brandmeister-talkgroups/" target="_blank">List of Available BrandMeister Talkgroups (sortable &amp; downloadable)...</a></b></td>'."\n";
	echo '    </tr>'."\n";
	echo '  </table>'."\n";
    }
}
