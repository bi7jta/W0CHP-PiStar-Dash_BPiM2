...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" lang="en">
	...
	<div class="container">
		...
		<div style="font-size: 10px; text-align: right; padding-right: 8px;"><div id="CheckUpdate"><?php echo $lang['dashboard'].": ".$version; system('/usr/local/sbin/pistar-check4updates'); ?></div></div>
