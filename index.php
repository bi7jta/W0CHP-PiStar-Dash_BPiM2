...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" lang="en">
	...
	<div class="container">
		...
		<div style="font-size: 10px; text-align: right; padding-right: 8px;">Pi-Star: <code>v<?php echo $_SESSION['PiStarRelease']['Pi-Star']['Version'].'</code><br />';?><div id="CheckUpdate"><code><?php echo $lang['dashboard'].": ".str_replace("_Ver.#", " #",$version)."</code> "; system('/usr/local/sbin/pistar-check4updates'); ?></div></div>
