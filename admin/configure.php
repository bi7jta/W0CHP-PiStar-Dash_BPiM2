...
<div class="container">
<div class="header">
<div style="font-size: 8px; text-align: left; padding-left: 8px; float: left;">Hostname: <?php echo exec('cat /etc/hostname'); ?></div>
...
if (!empty($_POST)):
	...
	if (empty($_POST['dmrMasterHost']) != TRUE ) {
      ...
      if ((isset($_POST['bmHSSecurity'])) && substr($dmrMasterHostArr[3], 0, 2) == "BM") {
		...
		if ((substr($dmrMasterHostArr[3], 0, 4) == "DMR+") || (substr($dmrMasterHostArr[3], 0, 3) == "HB_") || (substr($dmrMasterHostArr[3], 0, 9) == "FreeStar_") || (substr($dmrMasterHostArr[3], 0, 8) == "FreeDMR_")) {
