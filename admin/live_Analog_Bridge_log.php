...
if ($_SERVER["PHP_SELF"] == "/admin/live_Analog_Bridge_log.php") {
  ...
  $logfile = "/var/log/Analog_Bridge.log";
...
<link rel="shortcut icon" href="/images/favicon.ico" type="image/x-icon" />
    ...
    $(function() {
      $.repeat(1000, function() {
        $.get('/admin/live_Analog_Bridge_log.php?ajax', function(data) {
  ...
  <body>
	  ...
	  <div class="contentwide">
	      <table width="100%">
		  <tr><th><?php echo "live_Analog_Bridge_log"?></th></tr>
      ...
      <tr><th align="right"> 
          <button class="button" onclick="location.href='/admin/download_Analog_Bridge_log.php'" style="margin:2px 5px;">Download Analog_Bridge Log</button>
          <button class="button" onclick="location.href='/admin/download_MMDVM_Bridge_log.php'" style="margin:2px 5px;">Download MMDVM_Bridge Log</button>
          <button class="button" onclick="location.href='/admin/download_Allstarlink_log.php'" style="margin:2px 5px;">Download Allstarlink Log</button>
