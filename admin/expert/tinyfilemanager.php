...
require($fm_config_file); // Config file: /etc/tinyfilemanager-config.php
require($fm_auth_file); // Auth file: /etc/tinyfilemanager-auth.php
...
//$auth_users = array(
//    'root' => '$2y$10$/K.hjNr84lLNDt8fTXjoI.DBp6PpeyoJ.mGwrrLuCZfAwfSAGqhOW', //admin@123
//    'pi-star' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO', //12345
//);
...
$root_fs_path = $_SERVER['DOCUMENT_ROOT'];
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="text-center">
                                            <h1 class="card-title2">Pi-Star</h1>
                                        </div>
                                        <div class="text-center">
 ...
 * @return string
 */
function fm_clean_path_NE($path, $trim = true)
{
...
function fm_get_directorysize($directory) {
	...
	{
	    return 'ERROR: Can\'t read content';
	}
    }
    else
 ...
 class FM_Config
{
    ...
    {
        global $root_path, $root_url, $CONFIG, $fm_config_file;
        $fm_url = $fm_config_file;//'/etc/tinyfilemanager-config.php';//$root_url.$_SERVER["PHP_SELF"];
        $this->data = array(
            'lang' => 'en',
    ...
    function save()
    {
        global $root_fs_path, $fm_config_file;
        $fm_file = $fm_config_file;//'/etc/tinyfilemanager-config.php';$root_fs_path.$_SERVER["PHP_SELF"];
        $var_name = '$CONFIG';
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right">
                    ...
                    <li class="nav-item">
		      	<a title="Pi-Star Dashboard" class="nav-link" href="/admin/expert"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Dashboard </a>
                    </li>
                    <?php if (!FM_READONLY): ?>
                    <li class="nav-item">
...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        #editor { position:relative;max-width:100%;padding:10px 10px 10px 10px;min-height:400px;bottom-margin:10px;  }
