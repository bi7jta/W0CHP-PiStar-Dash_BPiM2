...
$lang = array (
  // Banner texts
  "digital_voice"               =>  "Dźwięk cyfrowy",
  "configuration"               =>  "Konfiguracja",
  "dashboard_for"               =>  "Dashboard dla",
  // Banner links
  "dashboard"                   =>  "Dashboard",
  "admin"                       =>  "Admin",
  ...
  "xlx_master"                  =>  "Wybór modułu XLX",
  "xlx_enable"                  =>  "Włączenie XLX",
  "xlx_startup_tg"              =>  "XLX Startup TG",
  "xlx_startup_module"          =>  "XLX Startup Module",
  "dmr_cc"                      =>  "Kolor Kod DMR ",
  "dmr_embeddedlconly"          =>  "Tylko wbudowany LC DMR",
  "dmr_dumptadata"              =>  "Zrzut danych DMR",
