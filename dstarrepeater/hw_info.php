...
<div class="divTable" id="hwInfoTable">
  <div class="divTableBody">
    <div class="divTableRow">
      <div class="divTableHeadCell"><a class="tooltip" href="#"><?php echo $lang['cpu_load'];?><span><strong>Plaform Info</strong><br/>Platform: <?php echo $_SESSION['PiStarRelease']['Pi-Star']['Platform'];?><br />Linux Kernel: <?php echo php_uname('r');?><br />Uptime: <?php  echo exec('uptime -p');?></a></span></div>
